...
class GridSystem {
    constructor() {
        ...
        this.mapDefaultPowers = {
            "area1": [this.powerList[2], this.powerList[2],this.powerList[2],this.powerList[1],],
            ...
            "area4": [this.powerList[2], this.powerList[2],this.powerList[2],this.powerList[2],this.powerList[2],this.powerList[1],],
            "area5": [this.powerList[2], this.powerList[2],this.powerList[2],this.powerList[2],this.powerList[1],],
        }

        this.startArea = "area2";
        this.defaultStartingPoints = {
            "area1": {"p1": {x:32,y:19}, "p2": {x:1,y:10}, "p3": {x:1,y:11}, "p4": {x:1,y:12}, "p5": {x:1,y:13}, "p6": {x:1,y:14}, "p7": {x:1,y:15}, "p8": {x:1,y:16}, "p9": {x:1,y:17}, "p10": {x:1,y:18}, "p11": {x:1,y:19},},
        ...
        this.playersArr = [
            this.p1 = new Player({x: 1, y: 10, lable: 13, id: this.extraArr[0], area: "area2", color: "grey", startingSteps: 500}),
            ...
            this.p4 = new Player({x: 16, y: 11, lable: 5, id: this.extraArr[3], area: "area2", color: "lightblue"}),
            this.p5 = new Player({x: 16, y: 12, lable: 6, id: this.extraArr[4], area: "area2", color: "moccasin"}),
            this.p6 = new Player({x: 16, y: 13, lable: 7, id: this.extraArr[5], area: "area2", color: "deepskyblue"}),
            this.p7 = new Player({x: 17, y: 7, lable: 8, id: this.extraArr[6], area: "area2", color: "white"}),
            this.p8 = new Player({x: 17, y: 8, lable: 9, id: this.extraArr[7], area: "area2", color: "hotpink"}),
            this.p9 = new Player({x: 17, y: 9, lable: 10, id: this.extraArr[8], area: "area2", color: "teal"}),
            this.p10 = new Player({x: 17, y: 12, lable: 11, id: this.extraArr[9], area: "area2", color: "yellow"}),
            this.p11 = new Player({x: 17, y: 13, lable: 12, id: this.extraArr[10], area: "area2", color: "turquoise"})
        ];
